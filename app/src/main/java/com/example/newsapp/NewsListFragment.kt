...
class NewsList : Fragment() {
    ...
    val newsObjects=mutableListOf<News>()
        newsObjects.add(
            News("Covid: J&J vaccine shows strong immune response",
                "A single dose of Johnson & Johnson's experimental Covid-19 ")
        )
        newsObjects.add(
            News("Section 144 imposed in Rajasthan's Banswara",
        ...
        newsObjects.add(
            News("Most COVID positive patients have one of these symptoms, as per CDC",
        ...
        newsObjects.add(
            News("First man cured of HIV infection now has terminal cancer",
        ...
        newsObjects.add(
            News("IPL 2020: Anushka Sharma calls Sunil Gavaskar's remark 'distasteful",
        ...
        newsObjects.add(
            News("Anil Ambani discloses worldwide assets to UK court in Chinese banks case",
            "Anil Ambani discloses worldwide assets to UK court in Chinese banks case")
        )
        newsObjects.add(
            News("Highly effective coronavirus antibodies identified, may lead to passive Covid-19 vaccine",
